  ...
  return (
    <section id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[50rem]">
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              src="https://www.yellowwei.cn/img/0cf11687-8451-4f34-b06d-3306b527dc8a.jpg"
            />
          </motion.div>
          <motion.span
            initial={{ opacity: 0, scale: 0 }}
      ...
      <motion.h1 className="mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-3xl" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }}>
        <span className="font-bold">Hello, I'm Yellowwei.</span> I'm a <span className="font-bold">full-stack developer</span> with <span className="font-bold">1 year</span> of experience. I enjoy
        building <span className="italic">sites & apps</span>. My focus is <span className="underline">React (Next.js)</span>.
      </motion.h1>
      <motion.div
      ...
      >
        ...
        <a
          ...
          href="https://github.com/yellowweii"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
